...
export default defineComponent({
  ...
  setup() {
    ...
    const freshStart = async () => {
      if (getWallet() && getConnection()) {
        ...
        try {
          ...
          console.log(`farm with PK `+farm1+` not found :(`);
        }
      }
    };
    ...
    const initFarmer = async () => {
      ...
      await gf.initFarmerWallet(new PublicKey(farm1));
      await fetchFarmer();
    };
    ...
    const beginStaking = async () => {
      ...
      await gf.stakeWallet(new PublicKey(farm1));
      await fetchFarmer();
      selectedNFTs.value = [];
    };
    ...
    const endStaking = async () => {
      ...
      await gf.unstakeWallet(new PublicKey(farm1));
      await fetchFarmer();
      selectedNFTs.value = [];
    };
